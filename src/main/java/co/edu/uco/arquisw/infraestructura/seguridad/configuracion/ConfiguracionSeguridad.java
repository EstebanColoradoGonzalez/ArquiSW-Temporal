...
import co.edu.uco.arquisw.infraestructura.seguridad.filtro.FiltroGeneradorJWT;
import co.edu.uco.arquisw.infraestructura.seguridad.filtro.FiltroValidadorJWT;
...
public class ConfiguracionSeguridad extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().
                ...
                .antMatchers("/api/usuarios").hasAnyRole("ROLE_USUARIO")
                .and().httpBasic();
    }
